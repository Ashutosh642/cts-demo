...
const TitanWatch = ({ SonataWatch }) => {
    return (
        <>
            <div class="container">
                <div class="row">
                    {SonataWatch.map(({ image, name,
                        assured,
                        price: { originalPrice, offerPrice, offer }

                    }) =>
                        <div class="col-sm-4">
                            <div class="card shadow mt-3  mb-5 bg-white rounded " style={{ width: '18rem', height: '23rem' }}>
                                <div class="card-body">
                                    <div class="row">
                                        <div className="col">
                                            <img src={image} height='175' width='140' />
                                        </div>
                                    </div>
                                    <div class="row">
                                        <b>{name}</b>
